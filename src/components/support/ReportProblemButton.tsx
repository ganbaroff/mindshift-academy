  ...
  if (phase === "anonymous") {
    return (
      <p
        ...
        className="fixed bottom-24 left-3 z-50 max-w-[16rem] rounded-2xl border border-white/10 bg-[var(--color-bg-base)]/95 px-3 py-2 text-xs text-white/70 backdrop-blur"
    ...
    return (
      ...
      >
        ...
        <textarea
          ...
          rows={3}
          className="w-full rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-base outline-none focus:border-violet-400/50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-300"
        />
        <div className="flex gap-2">
          ...
          <button
            ...
            className="min-h-11 rounded-xl border border-white/15 px-4 text-sm text-white/70 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-300"
          >
            Закрыть
          </button>
        </div>
