...
export const AchievementGrid = () => {
  ...
  return (
    <div className="flex flex-col gap-2 flex-grow justify-end">
      <span className="text-[var(--text-muted)] text-xs font-bold uppercase tracking-wider">Твои Ачивки</span>
          ...
          <div
            ...
            className={`aspect-square rounded-xl border flex flex-col items-center justify-center text-2xl relative group transition-transform focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-400 focus-visible:ring-offset-2 focus-visible:ring-offset-surface ${
              ach.unlocked
                ...
                : "border-[var(--border-color)] bg-[var(--surface-strong)] opacity-30"
            }`}
          >
            <span aria-hidden="true">{ach.emoji}</span>

            <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-1 bg-black/90 border border-[var(--border-color)] text-[10px] text-[var(--ink)] rounded-lg opacity-0 group-hover:opacity-100 group-focus:opacity-100 group-focus-within:opacity-100 pointer-events-none transition-opacity duration-200 whitespace-nowrap z-50 shadow-xl">
