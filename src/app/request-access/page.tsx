...
export default function RequestAccessPage() {
  ...
  return (
    <main className="relative isolate flex min-h-screen items-center justify-center overflow-hidden bg-background px-6 py-12 text-foreground">
      ...
      <section className="relative z-10 w-full max-w-md rounded-[28px] border border-white/10 bg-surface/90 p-8 shadow-[0_30px_120px_rgba(0,0,0,0.28)]">
        {sent ? (
          <div className="text-center">
            <span className="mx-auto mb-5 grid h-12 w-12 place-items-center rounded-2xl border border-white/10 bg-white/[0.04]">
              <CheckCircle2 className="h-6 w-6 text-primary-soft" aria-hidden="true" />
            </span>
            <h1 className="text-2xl font-semibold text-white">Заявка принята</h1>
            <p className="mt-3 text-sm leading-6 text-white/64" aria-live="polite">
          ...
          <>
            ...
            <h1 className="text-center text-2xl font-semibold text-white">Заявка на доступ</h1>
            <p className="mt-3 text-center text-sm leading-6 text-white/64">
            ...
            <form className="mt-7 space-y-4" onSubmit={submit} noValidate>
              <div className="space-y-1.5">
                <label htmlFor="ar-email" className="block text-sm font-medium text-white/80">
                  Почта родителя
                </label>
                <input
                  id="ar-email"
                  ...
                  className="h-12 w-full rounded-2xl border border-white/15 bg-surface-strong/90 px-4 text-base text-white outline-none transition-[border-color,box-shadow] placeholder:text-white/35 focus-visible:border-primary/70 focus-visible:ring-2 focus-visible:ring-primary/30"
                />
              </div>

              <div className="space-y-1.5">
                <label htmlFor="ar-name" className="block text-sm font-medium text-white/80">
                  Как к вам обращаться <span className="text-white/45">(необязательно)</span>
                </label>
                <input
                  id="ar-name"
                  type="text"
                  ...
                  className="h-12 w-full rounded-2xl border border-white/15 bg-surface-strong/90 px-4 text-base text-white outline-none transition-[border-color,box-shadow] focus-visible:border-primary/70 focus-visible:ring-2 focus-visible:ring-primary/30"
                />
              </div>

              <div className="space-y-1.5">
                <label htmlFor="ar-note" className="block text-sm font-medium text-white/80">
                  Пара слов о запросе <span className="text-white/45">(необязательно)</span>
                </label>
                <textarea
                  id="ar-note"
                  rows={3}
                  ...
                  className="w-full rounded-2xl border border-white/15 bg-surface-strong/90 px-4 py-3 text-base text-white outline-none transition-[border-color,box-shadow] focus-visible:border-primary/70 focus-visible:ring-2 focus-visible:ring-primary/30"
                />
                <p id="ar-note-hint" className="text-xs leading-5 text-white/50">
              ...
              <button
                ...
                className="inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-2xl bg-primary px-6 text-sm font-semibold text-white transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60 disabled:cursor-not-allowed disabled:opacity-50"
              >
