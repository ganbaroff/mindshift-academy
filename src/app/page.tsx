...
const benefitsRu = [
  ...
  },
  {
    ...
    copy: "Все голосовые сообщения и данные ребёнка удаляются в течение 48 часов.",
    icon: Award,
  },
] as const;
...
const benefitsAz = [
  ...
  },
  {
    ...
    copy: "Övladınızın bütün səs yazıları və məlumatları 48 saat ərzində tamamilə silinir.",
    icon: Award,
  },
] as const;
